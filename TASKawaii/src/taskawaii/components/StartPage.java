...
/**
 *This is the StartPage the user sees if there is no userdata.ser yet.
 * @author Raphael
 */
public class StartPage extends JFrame {

    /**
     *The constructor takes in a User object.
     * @param user the new user that will be referenced in the startPage
     */
    ...
    /**
     *This initializes the components for the StartPage.
     */
